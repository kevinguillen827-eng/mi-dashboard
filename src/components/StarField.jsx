 ...
 * - Al mover el mouse en cualquier parte de la ventana, las estrellas se
 *   desplazan suavemente en dirección opuesta al cursor (efecto profundidad).
 *   Se escucha a nivel de window (no solo del contenedor) para que siga
 *   funcionando aunque haya contenido con más z-index encima.
 *
...
export default function StarField({ count = 140 }) {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      mouse.current.x = (e.clientX / window.innerWidth - 0.5) * 2; // -1 a 1
